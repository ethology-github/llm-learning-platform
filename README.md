...
本项目提供了一个学习网站界面，可以帮助您更方便地浏览课程内容、跟踪学习进度和管理学习笔记。

### 启动学习网站

**最简单的方法：**

直接双击运行项目根目录下的 `启动学习网站.bat` 文件即可启动学习网站。

这个批处理文件会自动：
1. 检查Python环境
2. 安装必要的依赖包（streamlit、pandas、matplotlib、seaborn）
3. 启动Streamlit应用

如果遇到SSL连接问题，批处理文件会提供国内镜像源选项，帮助您成功安装依赖。
